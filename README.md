...
![index](https://github.com/animber-coder/aws-utils/blob/main/images/get-batchitem.png)

Compare DynamoDB GetItem and BatchGetItem API calls.

# [7: Bucket Size](#7-bucket-size)
![index](https://github.com/animber-coder/aws-utils/blob/main/images/bucket-size.png)
...
Executable can be downloaded from [here](https://github.com/animber-coder/aws-utils/blob/main/sqs_workbench.zip).
Unzip the folder and run the sqs_workbench.exe file.
![index](https://github.com/animber-coder/aws-utils/blob/main/images/sqs-playa.png)

#[14: Lambda Region Price](#14-lambda-region-price)
This [python utility](https://github.com/animber-coder/aws-utils/blob/main/lambda_type_price_to_csv.py) writes price for each lambda type in each region to csv.
![index](https://github.com/animber-coder/aws-utils/blob/main/images/lambda-price.png)
